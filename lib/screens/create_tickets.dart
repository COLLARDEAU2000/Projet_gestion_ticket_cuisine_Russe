            ...
            child: Row(
              ...
              children: [
                Switch(
                  ...
                  activeColor: Colors.yellow, // Couleur du bouton lorsque le switch est ouvert
                  activeTrackColor: Colors.red, // Couleur du fond lorsque le switch est ouvert
                ),
                                        ...
                                        onPressed: () async {
                                          ...
                                          ListTemperaturesTicketCreation =
                                              await DatabaseHelper.getTemperaturesByCategoryIdSubCategoryIdIsOpen(
                                                  subCategories[index].id, isOpening ? 1 : 0);
